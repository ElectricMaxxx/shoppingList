...
function start()
{
	...
	app.get("/admin/:controller/:action?",methodExistFilter(),function(req,res)
	{
		...
		//require(__dirname+"/../../application/module/"+controller+"/"+controller+".js")[action](req,res);
                require("../../application/node_modules/"+controller+"/node_modules/"+controller)[action](req,res);
...
var methodExistFilter = function()
{
	return function(req,res,next)
	{
		var controller = req.params.controller;
		var action = (req.params.action) ? req.params.action : "index";
		var controllerObj = require("../../application/node_modules/"+controller+"/node_modules/"+controller+".js");
